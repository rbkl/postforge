"""
Django settings for linkedinposter project.
"""
...
ROOT_URLCONF = 'linkedinposter.urls'
...
WSGI_APPLICATION = 'linkedinposter.wsgi.application'
...
try:
    ...
    # Fallback to SQLite if dj_database_url not installed (local dev)
    DATABASES = {
        'default': {
...
# LLM Provider (options: 'openai', 'deepseek')
...
if not DEBUG:
    # Trust Railway's proxy for SSL (Railway terminates SSL at the edge)
